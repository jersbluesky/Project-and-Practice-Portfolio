...
"""
Class is created to simply initiate a point with an x and y coordinate.
"""
class Point:
    def __init__(self):
        self.x = 0.00
...
"""
This class creates the ball and provides rules for the ball, including the
balls size, the velocity by which it starts and moves, and its starting point.
It also creates a point for it to restart.
"""
class Ball:
    def __init__(self):
        self.center = Point()
...
"""
The Paddle class allows for the creation of the paddle, the paddle size,
and the movement properties.
"""
class Paddle:
    
    def __init__(self):
        self.center = Point()
        self.center.x = SCREEN_WIDTH - 15
