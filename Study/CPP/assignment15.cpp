...
*    Estimated:  0.5 hrs   
*    Actual:     0.5 hrs
*      Most difficult part was determining where to place
*      the expression within the function.
************************************************************************/
...
/*****************************************************
 *The following function will return true if the 
 * tithing amount is greater than or equal to
 * the income divided by 10.
 *****************************************************/
bool isFullTithePayer(float income, float tithe)
{
   // 'Return true if' expression is below.
