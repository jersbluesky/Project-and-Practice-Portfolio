...
function calculate_total() {
    var total_dyno = (parseInt(document.getElementById("item_0").value) * DYNO_PRICE);
    var total_android = (parseInt(document.getElementById("item_1").value) * ANDROID_PRICE);
    var total_lamp = (parseInt(document.getElementById("item_2").value) * LAMP_PRICE);
    var total_dragon = (parseInt(document.getElementById("item_3").value) * DRAGON_PRICE);
